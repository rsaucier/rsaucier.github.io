...
To make use of the Vector class, simply include the [`Vector.h`][Vector.h code] class file,
and to make use of both the Vector and Rotation classes,
simply include the [`Rotation.h`][Rotation.h code] class file in your C++ program.

[Vector.h code]: /assets/Vector.h
[Rotation.h code]: /assets/Rotation.h

[Vector.pdf]: /assets/Vector.pdf
[Rotation.pdf]: /assets/Rotation.pdf
